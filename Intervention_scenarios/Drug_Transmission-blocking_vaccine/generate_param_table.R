...
training_folder = "~/MMC/TPP/simulations/cohort_MDA_short_TBV/"
test_folder = "~/MMC/TPP/simulations/test_sets/test_cohort_MDA_short_TBV/"
...
experiment = "cohort_MDA_TBV_once_3_years"
EIR = c(1, 25)
