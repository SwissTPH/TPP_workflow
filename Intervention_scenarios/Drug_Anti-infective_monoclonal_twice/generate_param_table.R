...
training_folder = "~/MMC/TPP/simulations/cohort_MDA_short_MAB_twice/"
test_folder = "~/MMC/TPP/simulations/test_sets/test_cohort_MDA_short_MAB_twice/"
...
experiment = "cohort_MDA_short_MAB_twice"
EIR = c(1, 25)
