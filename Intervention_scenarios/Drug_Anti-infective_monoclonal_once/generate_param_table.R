...
training_folder = "~/MMC/TPP/simulations/cohort_MDA_short_MAB_once/"
test_folder = "~/MMC/TPP/simulations/test_sets/test_cohort_MDA_short_MAB_once/"
...
experiment = "cohort_MDA_short_MAB_once"
EIR = c(1, 25)
