...
table_file = "~/MMC/TPP/simulations/preprandial_once_3years/param_tab.txt"
ranges_file = "~/MMC/TPP/simulations/preprandial_once_3years/param_ranges.RData"
...
experiment = "Preprandial_once_3_years"
EIR = c(1, 25)
Halflife = c(0.5, 5)
Preprandial_efficacy = c(0.3, 0.99)
Coverage = c(0, 1)
Access = c(0, 0.5)
param_ranges = rbind(EIR, Halflife, Preprandial_efficacy, Coverage, Access)
