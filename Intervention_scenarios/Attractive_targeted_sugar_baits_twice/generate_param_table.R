...
table_file = "~/MMC/TPP/simulations/ATSB_twice_sync_3years/param_tab.txt"
ranges_file = "~/MMC/TPP/simulations/ATSB_twice_sync_3years/param_ranges.RData"
...
experiment = "ATSB_twice_sync_3_years"
EIR = c(1, 25)
...
Xcand = as.data.frame(lhs(500, param_ranges))
