...
plot_ts = function(exp_list, exp_names, seas) {
    ...
    for (exp_n in 1:length(exp_list)) {
        ...
        scenarios_list = param_tab[which(param_tab$EIR > EIR_req[1] & 
                                             ...
                                             param_tab$Efficacy > Eff_req[1] &
                                             param_tab$Efficacy < Eff_req[2] &
                                             param_tab$Halflife > Hl_req[1] &
                                             param_tab$Halflife < Hl_req[2] &
                                             param_tab$Seasonality == seas &
                                             param_tab$Biting_pattern == "High_indoor"),]
...
exp_list = c("/scicore/home/smith/golmon00/MMC/TPP/simulations/cohort_MDA_PEV_once_3years/",
             "/scicore/home/smith/golmon00/MMC/TPP/simulations/PEV_once_3years/")
exp_names = c("MDA + anti-infective vaccine", "Anti-infective vaccine")

# exp_list = c("/scicore/home/smith/golmon00/MMC/TPP/simulations/cohort_MDA_MAB_once_3years/",
#              "/scicore/home/smith/golmon00/MMC/TPP/simulations/MAB_once_3years_avg_prev/")
# exp_names = c("MDA + anti-infective monoclonal", "Anti-infective monoclonal")
